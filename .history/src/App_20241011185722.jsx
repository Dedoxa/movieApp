...
export default class App extends React.Component {
  state = {
    ...
    activeTabKey: '1', // Стандартная вкладка "Search"
  };
  ...
  getGenreList() {
    this.TMDB.getResource('https://api.themoviedb.org/3/genre/movie/list?language=en').then((res) => {
      this.setState({
        genresList: res.genres, // genresList: res.genres
      });
    });
  }
  ...
  handleTabChange = (key) => {
    this.setState({
      activeTabKey: key, // Переключение вкладок
    });
  };
  ...
  render() {
    ...
    // Если жанры не загружены, получаем их

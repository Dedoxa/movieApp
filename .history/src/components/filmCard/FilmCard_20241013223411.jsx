...
export default class FilmCard extends React.Component {
  ...
  render() {
    const { poster_path, title, release_date, overview, vote_average, genre_ids, userRating, activeTabKey } = this.props.data;
    ...
    return (
      <div className="filmCard">
        ...
        <div className="filmInfo">
          ...
          <Rate allowHalf disabled={changableRate} defaultValue={userRating} count={10} className="starRate" onChange={this.handleRateChange} />
        </div>
      </div>
    );
  }

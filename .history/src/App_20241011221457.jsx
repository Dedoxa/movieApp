...
export default class App extends React.Component {
  ...
  render() {
    const { data, currentPage, totalPages, totalResults, ratedMovies, activeTabKey, handleRateChange, genresList } = this.state;
          ...
          <GenresContextProvider value={this.TMDB}>
            ...
            <div className="cardsArea">
              {data.results.map((movie) => (
                <FilmCard key={movie.id} data={movie} handleRateChange={handleRateChange} />
              ))}
            </div>
            <Button
              size="large"
